...
namespace Oxide.Plugins
{
    ...
    class IQBreakingTools : RustPlugin
    {
        ...
        private class Configuration
        {
            ...
            [JsonProperty("Список исключенных предметов")]
            public List<string> BlackTools = new List<string>();
        ...
        void OnLoseCondition(Item item, ref float amount)
        {
            ...
            if (config.BlackTools.Contains(item.info.shortname)) return;
