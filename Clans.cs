...
{
    [Info("Clans", "FuJiCuRa", "2.14.9", ResourceId = 14)]
    ...
    public class Clans : RustPlugin
    {
        ...
        private void cmdClanJoin(BasePlayer player, string[] args)
        {
            ...
            Interface.Oxide.CallHook("OnClanMemberJoined", current.Id, myClan.tag);
        ...
        private void cmdClanLeave(BasePlayer player, string[] args)
        {
            ...
            if (myClan.Total > 0)
            {
                ...
                Interface.Oxide.CallHook("OnClanMemberGone", current.Id, myClan.tag);
        ...
        private void cmdClanDisband(BasePlayer player, string[] args)
        {
            ...
            if (!lastMember)
            {
                ...
                Interface.Oxide.CallHook("OnClanDisbanded", myClan.tag, myClan.members.ToList());
            }
