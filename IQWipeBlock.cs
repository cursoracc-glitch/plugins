...
{
    [Info("IQWipeBlock", "shoprust.ru", "1.8.3")]
    ...
    class IQWipeBlock : RustPlugin
    {
        ...
        void Interface_Button_Panel(BasePlayer player)
        {
            ...
            {
                FadeOut = 0.2f,
                RectTransform = { AnchorMin = $"0.14 0.61", AnchorMax = $"1 1" },
            ...
            {
                FadeOut = 0.2f,
                RectTransform = { AnchorMin = $"0.20 0.34", AnchorMax = $"1 0.62" }, 
                Button = { Command = "block", Color = "0 0 0 0" },
            ...
            if (General.UseHidePanelButton)
            {
                ...
                {
                    FadeOut = 0.2f,
                    RectTransform = { AnchorMin = $"0.7 0.06", AnchorMax = $"1 0.34" },  
        ...
        void UI_IQ_WipeBlock(BasePlayer player)
        {
            ...
            {
                RectTransform = { AnchorMin = "0.15 0.92", AnchorMax = "0.83 0.98" }, //
            ...
            if (Interface.ShowInformationBlocks)
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent{ AnchorMin = "0.01 0.95", AnchorMax = "0.03 0.98", OffsetMax = "0 1", OffsetMin = "0 0.5" },
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent{ AnchorMin = "0.33 0.33", AnchorMax = $"0.65 0.65"},
                    }
                });

                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.03 0.95", AnchorMax = "0.12 0.98" },
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent{ AnchorMin = $"0.01 0.91", AnchorMax = $"0.03 0.94", OffsetMax = "0 1", OffsetMin = "0 1" },
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.03 0.91", AnchorMax = "0.12 0.94" },
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent{ AnchorMin = $"0.12 0.95", AnchorMax = $"0.14 0.98", OffsetMax = "0 1", OffsetMin = "0 1" },
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.14 0.95", AnchorMax = "0.27 0.98" },
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent{ AnchorMin = $"0.12 0.91", AnchorMax = $"0.14 0.94", OffsetMax = "0 1", OffsetMin = "0 1" },
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.14 0.91", AnchorMax = "0.27 0.94" },
            ...
            {
                FadeOut = 0.2f,
                RectTransform = { AnchorMin = $"0.81 0.92", AnchorMax = $"0.99 0.98" },
        ...
        Boolean Block_Skin_Controller(Configuration.Blocks.BlockElement BlockInfo, Dictionary<String, Configuration.Blocks.BlockElement> BlockAll, Boolean BlockStatusShortname, UInt64 SkinID = 0)
        {
            ...
            else if(SkinID == 2905002597) return true;
            else return false;
        ...
        static Double CurrentTime => Facepunch.Math.Epoch.Current;
                ...
                [PluginReference] Plugin IQChat, ImageLibrary, Battles, Duel, Duelist, ArenaTournament, AimTraining, XFarmRoom, OneVSOne, EventHelper; // https://umod.org/plugins/duelist
        ...
        void UI_Category_More_Popup(BasePlayer player, Configuration.Blocks.BlockElement BlockElement)
        {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.32 0.67", AnchorMax = "0.69 0.72" },  ///
            ...
            Single itemMargin = 0.06f; /// Расстояние между 
            ...
            foreach (var Item in BlockMore.OrderBy(i => i.Value).Take(28))
            {
                ...
                //         new CuiRectTransformComponent{ AnchorMin = "0.03 0.04", AnchorMax = $"0.94 0.95"},
                //     }
                // });
                ...
                if (!config.GeneralSetting.UseShowAllTime)
                {
                    if (SkipElement && TimeUnblock(ItemValue) > 0)
                    {
                        ...
                        container.Add(new CuiLabel
                        {
                            RectTransform = { AnchorMin = "0.06 0.76", AnchorMax = "0.94 0.98" },
        ...
        protected override void LoadConfig()
        {
            ...
            try
            {
                ...
                if (config.Interface.AnchorMinPositionSpriteLogo == null)
                    config.Interface.AnchorMinPositionSpriteLogo = "0.05 0";

                if (config.Interface.AnchorMaxPositionSpriteLogo == null)
                    config.Interface.AnchorMaxPositionSpriteLogo = "0.22 1";
            ...
            public static Configuration GetNewConfiguration()
            {
                return new Configuration
                {
                    ...
                    Interface = new Interfaces
                    {
                        ...
                        ButtonIsBlock = false,
                        UseFormatTime = false,
                        AnchorMinPositionSpriteLogo = "0.05 0",
                        AnchorMaxPositionSpriteLogo = "0.22 1",
        ...
        void UI_Category_Show(BasePlayer player, CuiElementContainer container, Configuration.Interfaces Interface, Dictionary<String, Configuration.Blocks.BlockElement> CategoryList, AlignCategory Align)
        {
            ...
            var Block = config.Block;
            Single FadeIn = 0.2f;
            String TitleX = Align == AlignCategory.Left ? "0.08 0.84" : Align == AlignCategory.Middle ? "0.40 0.84" : "0.71 0.84";
            String TitleY = Align == AlignCategory.Left ? "0.27 0.88" : Align == AlignCategory.Middle ? "0.58 0.88" : "0.91 0.88";
            ...
            String PanelX = Align == AlignCategory.Left ? "0.05 0" : Align == AlignCategory.Middle ? "0.36 0" : "0.68 0";
            String PanelY = Align == AlignCategory.Left ? "0.31 0.83" : Align == AlignCategory.Middle ? "0.62 0.83" : "0.94 0.83";
            String LineX = Align == AlignCategory.Left ? "0.08 0.84" : Align == AlignCategory.Middle ? "0.40 0.84" : "0.72 0.84";
            String LineY = Align == AlignCategory.Left ? "0.27 0.84" : Align == AlignCategory.Middle ? "0.59 0.84" : "0.91 0.84";
        ...
        Boolean Interface_UI_Block(BasePlayer player, String Shortname, String ShortnameModule = "", UInt64 SkinID = 0, List<Connection> playerList = null, Boolean IsCheckConnect = false)
        {
            ...
            if (!IsCheckConnect)
            {
                ...
                {
                    FadeOut = FadeOut,
                    RectTransform = { AnchorMin = "0.11 0.47", AnchorMax = "1 0.98" },
                    Text =
                    {
                ...
                {
                    FadeOut = FadeOut,
                    RectTransform = { AnchorMin = "0.11 0.04", AnchorMax = "1 0.54" },
                    Text =
                    {
        ...
        void HideButtonIsMenu(BasePlayer player)
        {
            ...
            container.Add(new CuiButton 
            {
                RectTransform = { AnchorMin = "0.15 0.90", AnchorMax = "0.83 0.93" }, 
