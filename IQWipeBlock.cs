...
{
    [Info("IQWipeBlock", "Mercury", "1.8.8")]
    ...
    class IQWipeBlock : RustPlugin
    {
        ...
        /// <summary>
        /// Обновление 1.
        /// - Добавлена обвязка с переносимыми ппредметами в IQBackpack 
        /// - Добавлена поддержка субмарин и блокирование торпед
        /// </summary>
        ...
        public String FormatTime(TimeSpan time, String UserID)
        {
            ...
            return Result;
                ...
                [PluginReference] Plugin IQChat, ImageLibrary, Battles, Duel, Duelist, ArenaTournament, AimTraining, XFarmRoom, OneVSOne, EventHelper, IQBackpack; // https://umod.org/plugins/duelist
        ...
        Boolean Interface_UI_Block(BasePlayer player, String Shortname, String ShortnameModule = "", UInt64 SkinID = 0, List<Connection> playerList = null, Boolean IsCheckConnect = false)
        {
            ...
            if (!IsCheckConnect)
            {
                ...
                {
                    FadeOut = FadeOut,
                    RectTransform = { AnchorMin = "0.1125769 0.041563643", AnchorMax = "1 0.5456369" },
                    Text =
                    {
        ...
        Boolean Block_Skin_Controller(Configuration.Blocks.BlockElement BlockInfo, Dictionary<String, Configuration.Blocks.BlockElement> BlockAll, Boolean BlockStatusShortname, UInt64 SkinID = 0)
        {
            ...
            else if(SkinID == 2905636597) return true;
            else return false;
        }
        ...
        void Interface_Button_Panel(BasePlayer player)
        {
            ...
            {
                FadeOut = 0.2f,
                RectTransform = { AnchorMin = $"0.2075757 0.3444443", AnchorMax = $"1 0.62665636" }, 
                Button = { Command = "block", Color = "0 0 0 0" },
            ...
            if (General.UseHidePanelButton)
            {
                ...
                {
                    FadeOut = 0.2f,
                    RectTransform = { AnchorMin = $"0.7 0.06666651", AnchorMax = $"1 0.348885636" },  
