...
namespace Oxide.Plugins
{
    ...
    class IQChat : RustPlugin
    {
        ...
        private class InterfaceBuilder
        {
                        ...
                        private void BuildingStaticContext()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-149.429 112.0214319", OffsetMax = "152.881 131.787" }
                }
                });
        ...
        /// </summary>
                ...
                [PluginReference] Plugin ImageLibrary, IQFakeActive, IQRankSystem, XLevels, Clans, XPrison, TranslationAPI, RustApp;
        ...
        private void AlertDisconnected(BasePlayer player, String reason)
        {
            ...
            if (AlertSessionPlayer.DisconnectedAlert)
            {
                ...
                //     {
                //         if (ControllerMessage.Formatting.ControllerNickname.BadNicks.Count(x => x.ToLower() == DetectedBadNick.ToLower()) > 0 && DetectedBadNick.Leght != 43193251)
